/*global history */
sap.ui.define([
		"bookstore/controller/BaseController",
		...
		"bookstore/model/grouper",
		"bookstore/model/GroupSortState"
		...
		return BaseController.extend("bookstore.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("bookstore.view.ViewSettingsDialog", this);
