sap.ui.define([
		...
		return BaseObject.extend("bookstore.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias bookstore.model.ListSelector
			 */
			 ...
			 * @return {bookstore.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
